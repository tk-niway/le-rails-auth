...
class Rails::TestUnit::TestParser < Ripper
  ...
  def on_args_new; end
  def on_bodystmt(arg, *); end
  def on_brace_block(*); end
  def on_command(arg, *); end
  def on_command_call(*, begin_lineno, _args); end
  def on_def(begin_line, *); end
  def on_do_block(*); end
  def on_ident(*); end
  def on_method_add_arg(arg, *); end
  def on_method_add_block(begin_line, end_line); end
  def on_stmts_add(arg, *); end
  def on_stmts_new(*); end
  def parse; end
  def self.definition_for(method_obj); end
end
...
class Rails::SourceAnnotationExtractor::ParserExtractor < Anonymous_Struct_4
...
class Rails::SourceAnnotationExtractor::PatternExtractor < Anonymous_Struct_5
  def annotations(file); end
end
...
class Rails::SourceAnnotationExtractor::Annotation < Anonymous_Struct_6
...
class Rails::Application::Configuration::Custom
  def initialize; end
  def method_missing(method, *args); end
  def respond_to_missing?(symbol, *); end
end
