...
class ActionDispatch::DeprecatedIllegalStateError < StandardError
end
...
class ActionController::Parameters
  ...
  def self.allow_deprecated_parameters_hash_equality; end
  def self.allow_deprecated_parameters_hash_equality=(val); end
...
class ActionDispatch::ExceptionWrapper::SourceMapLocation < Anonymous_Delegator_9
end
...
class ActionDispatch::Session::CookieStore::SessionId < Anonymous_Delegator_10
end
